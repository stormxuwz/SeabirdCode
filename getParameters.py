...
def getExpertGradientFromSeabirdObj(seabirdObj):
	...
	for legend in ["LEP","UHY","TRM"]:
		...
		if legend == "LEP":
			res["LEP_gradient"] = segGradient[idx]
			EPI_gradient = [segGradient[i] for i in range(idx)]
			res["EPI_meanGradient"] = np.mean(EPI_gradient)
		elif legend == "UHY":
	...
	# for seg in seabirdObj.thermocline.models["segmentation"].segmentList:
...
if __name__ == '__main__':
	...
	# directory = "/Users/wenzhaoxu/Desktop/test/"
	fullRes = []
	...
	df.to_csv("/Users/wenzhaoxu/Desktop/tmp.csv")
